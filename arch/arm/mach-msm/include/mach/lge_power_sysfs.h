...
const char *default_pwr_sysfs_path[PWR_SYSFS_PATH_NUM][3] = {
	...
	{"adc", "batt_id", "NULL"},
	{"adc", "pa_therm0", "NULL"},
	{"adc", "pa_therm1", "/sys/class/hwmon/hwmon0/device/pa_therm1"},
	...
	{"charger", "ichg_current", "/sys/class/power_supply/ac/current_max"},
	{"charger", "iusb_control", "NULL"},
	{"charger", "thermal_mitigation", "/sys/module/qpnp_charger/parameters/qpnp_thermal_mitigation"},
	...
	{"platform", "pcb_rev", "/sys/class/hwmon/hwmon0/device/pcb_revision"},
	/* testmode */
	{"testmode", "charge", "/sys/class/power_supply/battery/charging_enabled"},
	{"testmode", "chcomp", "/sys/class/power_supply/bms/chcomp"},
