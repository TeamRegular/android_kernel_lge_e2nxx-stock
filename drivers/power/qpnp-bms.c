...
struct qpnp_bms_chip {
    ...
    defined (CONFIG_MACH_MSM8926_E8LTE_KR) || defined (CONFIG_MACH_MSM8926_X10_VZW) || \
    defined (CONFIG_MACH_MSM8926_E2_VZW)
	int				vbat_uv;
#endif
...
#ifdef CONFIG_LGE_PM_BMS_CC_ACCURACY_ERROR_AFTER_EOC
